defmodule Memento.Query do
  ...
  `t:Memento.Table.memento_record/0`. This is equivalent to calling
  ...
  ```
  """
  @spec read(Table.name, any, options) :: Table.memento_record() | nil
  ...
  ```
  """
  @spec write(Table.memento_record(), options) :: Table.memento_record() | no_return
  ...
  ```
  """
  @spec all(Table.name, options) :: list(Table.memento_record())
  ...
  ```
  """
  @spec match(Table.name, tuple, options) :: list(Table.memento_record()) | no_return
  ...
  """
  @result [:"$_"]
  @spec select(Table.name, list(tuple) | tuple, options) :: list(Table.memento_record())
  ...
  """
  @spec select_raw(Table.name, term, options) :: list(Table.memento_record()) | list(term)
  ...
  This method accepts a `t:Memento.Table.memento_record/0` object and deletes
  ...
  ```
  """
  @spec delete_record(Table.memento_record(), options) :: :ok
