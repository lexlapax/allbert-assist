...
The thin TUI lifecycle documented on `main` begins with v1.2.4. Until that
...
v1.2.4 binary adds a best-effort inventory of known shipped components, required
