...
## Explicit non-goal through v0.12.2

Cross-device aggregate cap enforcement is out of scope through v0.12.2.
...
which depends on hosted/sync capabilities that are not planned for v0.12.2.
