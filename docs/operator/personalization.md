...
Personalization in the current v0.15.0 release is review-first local adapter training. It does not retrain a foundation model, does not send training data to hosted providers, and does not auto-activate trained weights.
