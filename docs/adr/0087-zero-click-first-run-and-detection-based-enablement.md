...
2026-07-27; v1.2.2 daemon-session process-ownership amendment accepted
...
**v1.2.2 process-ownership amendment.** ADR 0091 makes both launchers
...
session-admission operation on v1.2.2 and later.
