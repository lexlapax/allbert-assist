...
That gap becomes risky before v0.10 self-improvement. A rebuild skill or coding agent needs a declared development contract rather than whatever happens to be installed on the current machine.
...
- v0.10 self-improvement can assume a declared Rust toolchain contract.
...
- [docs/plans/v0.10-self-improvement.md](../plans/v0.10-self-improvement.md)
