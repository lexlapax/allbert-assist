...
- **Cursor** (multi-user collaborative cursor) — post-v0.38
...
- Bridge is internal-only. NOT exposed over HTTP / WebSocket /
  SSE in v0.26. (Public AG-UI endpoints are post-v0.38 work.)
...
Future work (post-v0.38, parked in `docs/plans/future-features.md`):
...
- Cursor (multi-user collaborative cursors) — post-v0.38.
- Plugin-contributed workspace regions — graduated in v0.32 (ADR 0024).
- Public AG-UI HTTP endpoint — post-v0.38.
- A2UI / MCP Apps interop — post-v0.38.
...
Rejected. Post-v0.38 work (per Future Features UI Protocol
