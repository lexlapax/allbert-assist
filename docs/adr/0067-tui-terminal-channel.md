...
v1.2.3 thin-client presentation amendment accepted 2026-07-28).
Date: 2026-06-21
...
ADR 0091 is the additive v1.2.3 successor for process and terminal ownership.
...
The v1.2.3 successor also relocates the v1.2 M9 compare-and-write described
...
alternate-screen constraint for the v1.2.3 thin terminal client after its
...
- A fresh built-in-profile local launch durably enables the TUI and maps it to
  ...
  state persists across TUI restarts. In v1.2.3 this setup is admitted and
