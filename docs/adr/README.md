...
- [ADR 0089: Long-term user memory architecture and consent boundary](0089-long-term-user-memory-architecture-and-consent.md) (Proposed — v1.3, implementation-ready)
...
- [ADR 0091: Daemon-backed TUI session protocol and thin terminal client](0091-daemon-backed-tui-session-protocol.md) (Proposed — v1.2.1 point enabler)
- [ADR 0092: Search Central and conversation FTS](0092-search-central-and-conversation-fts.md) (Proposed — v1.3)
