...
- [ADR 0098: Kernel application, pack contract, and tier model](0098-kernel-application-pack-contract-and-tier-model.md) (Accepted and implemented — v1.4.0 component contract baseline)
