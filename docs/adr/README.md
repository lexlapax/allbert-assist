...
- [ADR 0098: Kernel application, pack contract, and tier model](0098-kernel-application-pack-contract-and-tier-model.md) (Accepted for implementation — v1.4; M14/M16 promote the component contract baseline)
