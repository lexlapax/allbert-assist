...
- [ADR 0094: Knowledge Central and the derived wiki projection](0094-knowledge-central-and-derived-wiki.md) (Proposed — v1.6.x/v1.7)
- [ADR 0095: Knowledge schema authority and untrusted source ingestion](0095-knowledge-schema-authority-and-untrusted-source-ingestion.md) (Proposed — v1.6.x/v1.7)
