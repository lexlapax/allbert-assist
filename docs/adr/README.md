...
- [ADR 0084: Autonomous channel notification authority](0084-autonomous-channel-notification-authority.md) (Accepted — v1.1; v1.4 `:suggestion` amendment Proposed until M8)
...
- [ADR 0090: Adaptive usage profiling and confirmed customization](0090-adaptive-usage-profiling-and-confirmed-customization.md) (Proposed — accepts only at v1.4 M8)
