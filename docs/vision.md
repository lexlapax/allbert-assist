...
Beyond the shipped v0.12 self-improvement release the roadmap names two further planned releases. Both are staged after self-improvement so that Allbert's review surfaces, cost tracking, and operator posture are mature before the assistant edits durable personalization state or reasons about its own failures.
