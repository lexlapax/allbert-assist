...
Reality note as of 2026-04-26: v0.14.1 reconciles the v0.13/v0.14 drift around daemon adapter handlers, production trainer selection from configured backends, concrete self-diagnosis remediation candidates, local-default tool-call parsing, and doc-reality checks. Kernel compactness moves to the separate v0.14.2 core/services split instead of being bundled into the repair release.
