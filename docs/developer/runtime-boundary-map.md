...
| v0.48-v0.49 | Media resource facades | Expected to model v0.48 audio STT/TTS and v0.49 image/screenshot resources plus registered provider-backed actions. Shared profile media metadata is routing context only; video remains future scope unless a later plan accepts it. |
