...
| v0.53 | Mobile channel facades | Expected to expose WhatsApp, Signal, and Matrix channel adapters under the existing channel contract and inherited ADR 0057 threading capabilities. |
