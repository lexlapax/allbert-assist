...
`release.v121` is the exact ordered `release.v12` prefix plus six v1.2.4 steps:
...
v1.2.4 timing override does not execute it. At the clean pushed tag candidate,
...
operator-approved timing override applies: v1.2.4 and intermediate v1.3
