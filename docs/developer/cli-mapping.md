# Mix task -> `allbert` command mapping (v1.2.4 M0.a1)
...
v1.2.4 PTY runner and documented operator command apply that posture only to
their TUI child.
...
`allbert admin secrets migrate`. v1.2.4 adds the pre-runtime informational leaf
