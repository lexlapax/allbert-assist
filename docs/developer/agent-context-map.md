...
| v1.3 | Long-term user memory + Search Central, plus the release-candidate adaptive fan-out correction: bi-temporal claim streams, review, archive, tombstone-first Forget, a canonical Corpus boundary, one FTS5 search projection, canonical conversation deletion, rules-derived manager admission, exact-counted compatibility, selective one-turn Jido workers, and durable report composition. **Release candidate at time of writing.** | ADR 0089/0092/0093 plus ADR 0083/0021 amendments, v1.3 plan/request-flow, `release.v13`. |
