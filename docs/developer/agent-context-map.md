...
| v0.60 | Implementation complete; post-implementation remediation M8.1-M8.4 and M9.1-M9.5 implemented before manual validation; final pre-validation audit holds operator validation for M9.6 third-audit polish. Pre-1.0 product-experience design (design-first): information architecture, user journeys, onboarding-flow, persona, and entry-point design, the First-Model Path decision, and a walking skeleton. No shipped capability. | ADR 0077, ADR 0078, v0.60 docs, `release.v060`. |
