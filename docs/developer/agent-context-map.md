...
| v0.64 | Planned trusted install and non-developer first-run: installer-side verification/rollback posture, package-first docs, browser-first onboarding, repairable first-run states, and local-or-BYOK model setup to first useful chat. | v0.64 plan/request-flow, ADR 0076/0078. |
