...
| **Before anything expensive** | Until v1.4 M0.5 implements `mix allbert.test preflight`, run the active plan's enumerated cheap equivalent. After M0.5, the command is the under-two-minute mandatory phase. |
