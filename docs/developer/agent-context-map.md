...
- v0.57 (in progress; M0-M1 complete): Pi-mode Coding Surface. A gated terminal coding surface with a
  **six-tool** default (read-only/sensitive read/grep/glob + effectful
  ...
  output caps, redaction, and relative-path payloads. Milestones M2-M9 remain.
