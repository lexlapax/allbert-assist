...
- v0.54 (planned): Intent Deepening. Deepens the intent subsystem (ADR
  0019/0034) so a chat-primary surface routes reliably — classification,
  multi-turn/clarification, disambiguation; model output stays advisory.
