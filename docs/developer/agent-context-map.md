...
- v0.53 (planned): Channel Pack 2 - Matrix + WhatsApp (Cloud API) + Signal
  (signal-cli daemon); Viber on paper + deferred, iMessage/SMS parked. One large
  release (M0-M9, constructs-first). Finishes v0.52's unbuilt system-wide
