...
- v0.57 (in progress; M0-M3 complete): Pi-mode Coding Surface. A gated terminal coding surface with a
  **six-tool** default (read-only/sensitive read/grep/glob + effectful
  ...
  local-coding tier both resolve, and sub-agent spawn denial. Milestones M4-M9
  remain.
