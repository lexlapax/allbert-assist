...
- v0.55 (release-prepared as `0.55.0`; tag pending operator approval): Channel
  Parity + TUI/Terminal Channel. Explicit channel capability/parity matrix,
