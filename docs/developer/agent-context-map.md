...
- v0.53 (implemented as `0.53.0`; Telegram/email validation complete, Matrix/WhatsApp/Signal validation pending): Channel Pack 1 retro-validation (Telegram + email, first
