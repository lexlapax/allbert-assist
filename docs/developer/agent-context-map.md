...
| v0.58 | Pre-1.0 consolidation implemented through M13: surface contract, settings enforcement, web design system, operator panels, surface policy, redundancy cleanup, `:v058` eval rows, and `release.v058`. M14 manual operator validation is next. | ADR 0073/0074, ADR 0024 revision, `docs/developer/surface-contract.md`, `docs/developer/web-design-system.md`, `docs/operator/workspace.md`, v0.58 docs. |
...
- use `mix allbert.test release.v058` as the M13 deterministic handoff gate before
  M14 manual validation;
