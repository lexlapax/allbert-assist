...
| MCP server mode, expanded (actions as MCP tools; memory namespaces as MCP resources; + OpenAI-compatible HTTP API + ACP server; AG-UI/A2UI parked) | ADR 0044, `docs/plans/v0.51-plan.md`, `docs/plans/v0.51-request-flow.md` | v0.51 |
