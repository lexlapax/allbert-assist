...
| Provider capabilities, operator model preferences, voice, vision, and media resources | ADR 0051, ADR 0042, ADR 0047, `docs/plans/v0.48-plan.md`, `docs/plans/v0.48-request-flow.md`, `docs/developer/provider-capabilities.md`, `docs/operator/voice-and-provider-preferences.md`, `docs/plans/v0.49-plan.md`, `docs/plans/v0.49-request-flow.md` | v0.48-v0.49; v0.48 implements bounded STT/TTS, while richer realtime audio/video profile metadata remains routing/future scope |
