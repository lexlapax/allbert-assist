...
- v0.55.1 (release-ready as `0.55.1`, tag deferred): TUI Operator/Validation Console (point release). The v0.55
  ...
  evidence is retained in `docs/release-evidence/v0551/M5-operator-validation.md`;
  M6 full release evidence is retained under
  ...
  the release tag is intentionally deferred per operator instruction.
