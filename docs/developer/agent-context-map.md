...
| v0.60 | Planned pre-1.0 product-experience design (design-first): information architecture, user journeys, onboarding-flow, persona, and entry-point design, the First-Model Path decision, and a walking skeleton. No shipped capability. | ADR 0077, ADR 0078, v0.60 docs, `release.v060`. |
| v0.61 | Planned pre-1.0 product: Presentation Layer Overhaul — redesigned IA and screen composition, brand, motion, visual hierarchy, landing/marketing over the v0.58 design system. | ADR 0074 v0.61 amendment, v0.61 docs. |
