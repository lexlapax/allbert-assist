...
| v1.4 | Planned. Spine enablers: settings migration runner plus consumers, full param-contract enforcement, PermissionGate deletion, action-envelope consolidation. | ADR 0046, ADR 0065, v1.4 plan/request-flow. |
