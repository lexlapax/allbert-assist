...
- **1.2.2 — Foundational Binary Enablers** (planned in the active v1.3
...
Class: Must (foundational) (operator-confirmed 2026-07-27) · Effort: M · Slice: v1.2.2 point enabler before v1.3 schema work

Status: planned — `docs/plans/v1.3-plan.md`, v1.2.2 milestones; operator
...
The approved v1.2.2 milestones bind these minimum outcomes:
...
- v1.2.2 permits one terminal session per Home and no live resume. The daemon
...
Class: Must (confirmed 2026-07-14) · Effort: L · Slice: v1.3 flagship after the v1.2.2 point enabler
