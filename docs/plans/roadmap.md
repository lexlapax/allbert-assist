...
| v0.12.1 | Operator UX polish: shared activity awareness, responsive TUI, settings/command hub, legibility, approval context, channel-native Telegram, recovery, discovery, error hints | Draft | [v0.12.1-operator-ux-polish.md](v0.12.1-operator-ux-polish.md) |
| v0.12.2 | Tracing and replay: persisted session spans, trace/replay surfaces, privacy/redaction posture, protocol v4, OTLP-JSON export | Draft | [v0.12.2-tracing-and-replay.md](v0.12.2-tracing-and-replay.md) |
