...
| v0.9 | Developer environment and Codex Web readiness: pinned toolchain, contributor contract, provider-free validation | Proposed | [v0.9-developer-environment-and-codex-web.md](v0.9-developer-environment-and-codex-web.md) |
