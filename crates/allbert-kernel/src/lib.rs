...
pub use adapters::{
    ...
    write_adapter_manifest, AdapterActivation, AdapterCorpusConfig, AdapterCorpusItem,
    AdapterCorpusSnapshot, AdapterEvalArtifacts, AdapterStore, AdapterTrainer, CancellationToken,
