...
- Packaged releases include ERTS and selected runtime/native/data payloads, so
  ...
  generated inventory. v1.2.4 adds one deterministic final-artifact generator,
...
operator timing override: v1.2.4 and intermediate v1.3 milestones use only
...
delegate-agent steps. Read `docs/plans/archives/v0.25-plan.md`,
`docs/plans/archives/v0.25-request-flow.md`, ADR 0020, ADR 0021, and ADR 0022 before
touching this path.
...
accepted. Before changing delegate dispatch, read `docs/plans/archives/v0.46-plan.md`,
`docs/plans/archives/v0.46-request-flow.md`, and ADR 0021 amendment A21. Command
...
- v0.36 sandboxing is implemented as report-only per ADR 0037; v0.37 permits
  the narrow ADR 0032/0033/0035 exception for file-backed dynamic drafts. In-core
