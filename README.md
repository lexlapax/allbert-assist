...
Reality note: v0.14.1 reconciles daemon adapter handlers, production trainer selection from configured real backends, and concrete diagnosis remediation candidates. Kernel compactness moves to v0.14.2.
