...
curated-memory review and recovery, local vector RAG over
docs/settings/commands/memory/session recall, approval inbox resolution,
profile export/import, provider/model selection, telemetry/activity inspection,
trace replay/export, local personalization adapters, settings changes,
self-diagnosis reports, local utility enablement, self-improvement review, skill
authoring, scripting controls, and channel administration. Fresh profiles
