...
- adapter daemon protocol and production real-backend trainer selection are reconciled in v0.14.1
- hosted providers ignore active adapters; only local Ollama activation is supported in v0.13
- self-diagnosis explains by default; remediation is opt-in and always routes through existing review surfaces; concrete candidate generation is reconciled in v0.14.1
