defmodule AllbertResearch.Pack do
  @moduledoc """
  ...
  def descriptor do
    %Descriptor{
      ...
      provenance: %{source: :signed_release, component: "beam-allbert-research"},
  ...
  # The plugin already owned its schema through a dedicated Fragment module, so
  # this is the one extraction where the settings move is a re-declaration rather
  # than a reshape.
  @impl true
  def settings_fragments, do: [AllbertResearch.SettingsFragment]
  ...
  def test_lanes do
    [
      %{
        owner_id: :research,
        application: :allbert_research,
        cwd: "apps/allbert_research",
        production_source_roots: ["apps/allbert_research/lib"],
        test_roots: ["apps/allbert_research/test"],
        test_support_roots: [],
        ...
        historical_metrics_aliases: ["research"]
      }
    ]
  end
end
