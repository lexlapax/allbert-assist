defmodule Mix.Tasks.Allbert.Test do
  ...
  @v121_focused_steps [
    %{
      ...
      title: "v1.2.2 packaged-license, promotion, and daemon-TUI security contracts",
      cwd: :core,
      executable: "mix",
      args: ["test", "test/security/v121_sweep_eval_test.exs"],
      coverage: ["the thirteen named v1.2.2 release rows are behavior-bound"]
    },
    %{
  ...
  defp release_v121 do
    ...
    evidence = %{
      ...
      notes:
        "release.v12 prefix plus v1.2.2 packaged-license, promotion, daemon-TUI, and inventory contracts",
      steps: results
    }
