defmodule AllbertAssist.DynamicPlugins.Draft do
  ...
  @type t :: %__MODULE__{
          ...
          tier: String.t(),
          producer: String.t(),
          template_pattern_id: String.t() | nil,
  ...
  def new(attrs, opts \\ []) when is_map(attrs) do
    ...
    draft = %__MODULE__{
      ...
      template_pattern_id: value(attrs, "template_pattern_id"),
  ...
  def to_metadata_map(%__MODULE__{} = draft) do
    %{
      ...
      "template_pattern_id" => draft.template_pattern_id,
