defmodule AllbertAssist.Intent.Router.ClarifyResolver do
  ...
  """
  @type option :: %{required(:kind) => atom() | String.t(), required(:id) => String.t(), optional(any()) => any()}
  ...
  defp option_keywords(option) do
    ...
    (String.split(id, ~r/[^a-z0-9]+/i, trim: true) ++ String.split(label, ~r/[^a-zA-Z0-9]+/, trim: true))
