defmodule AllbertAssist.CLI.Areas.Memory do
  ...
  @usage """
  Usage:
    allbert admin memory status [--category notes|preferences|traces|skills|identity] [--user USER] [--all-users]
    allbert admin memory list [--category notes|preferences|traces|skills|identity] [--namespace identity] [--status unreviewed|kept|flagged|prune_nominated] [--limit N] [--since YYYY-MM-DD] [--user USER]
    allbert admin memory show PATH [--user USER]
    allbert admin memory review PATH --status kept|flagged|prune_nominated [--note "..."] [--user USER]
    allbert admin memory update PATH [--summary "..."] [--body "..."] [--note "..."] [--user USER]
    allbert admin memory delete PATH [--user USER]
    allbert admin memory archive PATH [--user USER]
    allbert admin memory restore CLAIM_ID [--tail-digest SHA256] [--user USER]
    allbert admin memory forget CLAIM_ID [--reason operator_requested|privacy|incorrect|expired] [--user USER]
    allbert admin memory prune [--category notes|preferences|traces|skills|identity] [--dry-run] [--write] [--user USER]
    allbert admin memory search QUERY [--category notes|preferences|traces|skills|identity] [--limit N] [--user USER]
    allbert admin memory retrieve --query "..." [--thread-id THREAD_ID] [--active-app APP_ID] [--identity-namespace identity] [--valid-at ISO8601] [--known-at ISO8601] [--now ISO8601] [--user USER]
    allbert admin memory consolidate [--user USER]
    allbert admin memory compile-index [--user USER]
    allbert admin memory summarize --category notes|preferences|traces|skills|identity [--user USER]
    allbert admin memory promote-turn --thread-id THREAD_ID --message-id MESSAGE_ID [--category notes] [--summary "..."] [--user USER]
    allbert admin memory proposals [--user USER]
    allbert admin memory proposal PROPOSAL_ID [--user USER]
    allbert admin memory proposal-review PROPOSAL_ID --revision N --digest SHA256 --operation keep|edit|reject [--claim-json JSON] [--spans-json JSON] [--claim-id ID] [--tail-digest SHA256] [--user USER]
    allbert admin memory proposal-keep-all --bindings-json JSON [--user USER]
  """
