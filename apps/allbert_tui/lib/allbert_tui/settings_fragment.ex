defmodule AllbertTUI.SettingsFragment do
  @moduledoc """
  Pack `FragmentOwner` for the Allbert TUI Channel.

  Derived from `AllbertTUI.Settings.Fragment`, which already held the schema and
  ...
  def entries do
    (AllbertTUI.Settings.Fragment.settings_schema() ++ Notify.settings_schema("tui"))
  ...
  def fragment do
    ...
    Fragment.new!(%{
      ...
      metadata: %{display_name: "Allbert TUI Channel", trust_status: :trusted, source: :shipped}
    })
  end
