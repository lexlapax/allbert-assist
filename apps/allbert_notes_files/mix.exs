defmodule AllbertNotesFiles.MixProject do
  use Mix.Project

  def project do
    [
      app: :allbert_notes_files,
      version: "1.3.2",
      build_path: "../../_build",
  ...
  # dependencies. The kernel supplies Action, Paths, Security and
  # Runtime.Response; the residual supplies Settings, Resources, App/Surface,
  # Plugin and Confirmations. That is a pack-to-pack edge, permitted by ADR 0098
  # section 2, and acyclic: nothing outside this application references the
  # AllbertNotesFiles namespace.
  defp deps do
    [
  ...
  def application do
    [
      ...
      env: [allbert_pack: AllbertNotesFiles.Pack]
    ]
  end
end
