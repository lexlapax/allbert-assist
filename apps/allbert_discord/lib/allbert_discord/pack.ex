defmodule AllbertDiscord.Pack do
  @moduledoc """
  Pack descriptor for the extracted Allbert Discord Channel.
  ...
  def descriptor do
    %Descriptor{
      ...
      provenance: %{source: :signed_release, component: "beam-allbert-discord"},
      registry_order: 700
    }
  end
  ...
  @impl true
  def settings_fragments, do: [AllbertDiscord.SettingsFragment]

  @impl true
  def cli_groups do
    [
      %{
        group_id: "allbert_discord.channels",
        command_path: ["admin", "channels", "discord"],
        module: AllbertDiscord.CLI
      }
    ]
  end
  ...
  def test_lanes do
    [
      %{
        owner_id: :discord,
        application: :allbert_discord,
        cwd: "apps/allbert_discord",
        production_source_roots: ["apps/allbert_discord/lib"],
        test_roots: ["apps/allbert_discord/test"],
        test_support_roots: [],
        ...
        historical_metrics_aliases: ["discord"]
      }
    ]
  end
end
