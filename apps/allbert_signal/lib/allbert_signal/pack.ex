defmodule AllbertSignal.Pack do
  @moduledoc """
  Pack descriptor for the extracted Allbert Signal Channel.
  ...
  def descriptor do
    %Descriptor{
      ...
      provenance: %{source: :signed_release, component: "beam-allbert-signal"},
      registry_order: 900
    }
  end
  ...
  @impl true
  def settings_fragments, do: [AllbertSignal.SettingsFragment]

  @impl true
  def cli_groups do
    [
      %{
        group_id: "allbert_signal.channels",
        command_path: ["admin", "channels", "signal"],
        module: AllbertSignal.CLI
      }
    ]
  end
  ...
  def test_lanes do
    [
      %{
        owner_id: :signal,
        application: :allbert_signal,
        cwd: "apps/allbert_signal",
        production_source_roots: ["apps/allbert_signal/lib"],
        test_roots: ["apps/allbert_signal/test"],
        test_support_roots: [],
        ...
        historical_metrics_aliases: ["signal"]
      }
    ]
  end
end
