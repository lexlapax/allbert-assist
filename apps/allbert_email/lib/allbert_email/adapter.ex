defmodule AllbertEmail.Adapter do
  @moduledoc false
  ...
  defp load_state(opts) do
    base = %{
      ...
      imap_client: Keyword.get(opts, :imap_client, AllbertEmail.ImapClient),
      smtp_client: Keyword.get(opts, :smtp_client, AllbertEmail.SmtpClient),
